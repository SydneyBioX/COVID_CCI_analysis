...
Run `run_scClassify_scMerge2_melanoma.R` script to annotate the cell types using Li et al. and integrate the two melanoma datasets.
...
Run `run_cell_chat_sadeFeldman.R` script to caculate CCI scores on each patient sample using `CellChat`.
